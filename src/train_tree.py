...
spark = SparkSession.builder.appName("AvazuDecisionTree").getOrCreate()
...
features = [
    ...
    "device_conn_type", "C1", "C14", "C15", "C16", "C17",
    "C18", "C19", "C20", "C21", "hour_of_day"
]
...
numeric_cols = [
    "banner_pos", "device_type", "device_conn_type", "C1",
